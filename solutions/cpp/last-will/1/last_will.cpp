...
namespace estate_executor {
	...
	int assemble_code() {
		int red_part = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
		int blue_part = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
